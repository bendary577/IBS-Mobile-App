...
const TransactionMessage = (props) => {
    return (
        <TouchableOpacity style={ props.item.statusFormatted === "closed" ? styles.conatinerClosed : styles.conatinerOpened} onPress={()=>{props.onHandlePress(props.item._id, props.item.id, props.item.statusFormatted)}}>
